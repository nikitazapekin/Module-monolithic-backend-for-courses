...
export class LessonDetailsFacade {
  ...
  getLessonDetailsByCheckpointId(
    checkpointId: string,
  ): Promise<LessonDetailsResponseDto> {
    return this.service.getLessonDetailsByCheckpointId(checkpointId);
  }
  ...
  deleteLessonDetailsByCheckpointId(
    checkpointId: string,
  ): Promise<{ success: boolean }> {
    return this.service.deleteLessonDetailsByCheckpointId(checkpointId);
  }
}
