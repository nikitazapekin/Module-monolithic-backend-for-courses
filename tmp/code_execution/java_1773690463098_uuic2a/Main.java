...
public class Main {
    public static int yourFunction(int n, Object z) {
        if (z instanceof Map) {
            Map<?, ?> map = (Map<?, ?>) z;
            if ("test".equals(map.get("test"))) {
                return 6;
            }
        } else if (z instanceof String) {
            String s = (String) z;
            if (s.contains("\"test\":\"test\"")) {
                return 6;
            }
        }
        return 0;
    ...
    public static void main(String[] args) {
        ...
        // Тест 1
        {
            ...
            try {
                Object result = yourFunction(1, new java.util.HashMap<>() {{ put("test" = "test"); }});
