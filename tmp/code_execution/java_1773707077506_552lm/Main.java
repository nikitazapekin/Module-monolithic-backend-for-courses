public class Main {
    public static int yourFunction(Object arg1) {
      Field field = arg1.getClass().getDeclaredField("field1");
            field.setAccessible(true); // Даже если поле приватное
            return (int) field.get(arg1);
    ...
    public static void main(String[] args) {
        ...
        // Тест 1
        {
            ...
            try {
                Object result = yourFunction(new Arg1(11));
